  ...
  return (
    <nav className="flex items-center justify-between px-4 py-3 bg-white shadow-sm">
      ...
      <ul className="flex space-x-10 ">
        <li><Link href="/how-to" className="text-gray-600 hover:text-gray-900">How to</Link></li>
        <li><Link href="/view" className="text-gray-600 hover:text-gray-900">View</Link></li>
        <li><Link href="/real" className="text-gray-600 hover:text-gray-900">Real</Link></li>
