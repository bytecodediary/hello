    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(default=backend.models.generate_unique_slug)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.CharField(choices=[('paid', 'paid'), ('refunded', 'refunded'), ('adjusted', 'adjusted')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default=(('sold', 'Sold'), ('pending', 'Pending'), ('available', 'Available')), max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.PositiveIntegerField(default=1)),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_items', to='backend.cart')),
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.property')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='property',
            name='landlord',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.property_lord'),
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('slug', models.SlugField(unique=True)),
                ('payment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='backend.payment')),
            ],
        ),
    ]
